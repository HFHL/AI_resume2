...
class UniversityClassifier:
    ...
    def _is_overseas_via_llm(self, university_name: str) -> Optional[bool]:
        ...
        prompt = (
            "Decide whether the given institution name is an overseas university. Output JSON only, no explanations.\n"
            "Output format: {\"overseas\": true|false|null}\n"
            "Rules:\n"
            "- overseas=true means overseas university; false means domestic (non-overseas).\n"
            "- If uncertain, set overseas=null.\n"
            "- Return exactly one JSON object.\n"
            "\nExamples:\n"
            "Input: 'Harvard University'\n"
            "Output: {\"overseas\": true}\n"
            "\nInput: '清华大学'\n"
            "Output: {\"overseas\": false}\n"
            "\nInput: '北京邮电大学'\n"
            "Output: {\"overseas\": false}\n"
